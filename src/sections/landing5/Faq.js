      ...
      <Container>
        <Row>
          <Col lg="6" className="mb-5">
            <FaqCard>
              <div>
                <FaqTitle>Can I use Zapezzy for my clients?</FaqTitle>
                <Text variant="small" color="light" opacity={0.7}>
                  Absolutely. The Envato Theme license allows you to build a
                  websites for personal use or for a client. User Zapezzy for your
                  clients.
                </Text>
              </div>
            </FaqCard>
            ...
            <FaqCard>
              <div>
                ...
                <Text variant="small" color="light" opacity={0.7}>
                  ...
                  without any design or custom coding. with Zapezzy that converts
